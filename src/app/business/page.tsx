  ...
  return (
    <main className="px-4 sm:px-6 lg:px-8 py-8 max-w-3xl mx-auto">
      ...
      <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-[var(--n-primary,#0000CC)] flex items-center justify-center flex-shrink-0 text-white text-lg">
            📦
          </div>
      ...
      <div className="mt-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <Link href="/feed/zero-day" className="text-xs text-[var(--n-primary,#0000CC)] hover:underline font-semibold">
            すべて見る →
          </Link>
        </div>
