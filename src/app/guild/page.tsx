  ...
  return (
    <main className="px-4 sm:px-6 lg:px-8 max-w-2xl mx-auto py-8 relative">
      ...
      <div className="flex items-start justify-between mb-6 gap-4">
        <div>
          <h1 className="text-2xl font-bold text-[var(--n-text,#1A1714)]">
            今日も、あなたの 時間 を AI が 守っています。
          </h1>
      ...
      <div className="bg-[var(--n-surface,#FFFFFF)] border border-[var(--n-positive,#0E9F4F)]/30 rounded-2xl px-5 py-4 mb-4">
        <div className="flex items-center justify-between gap-3 flex-wrap">
          <div>
            <p className="text-[11px] text-[var(--n-muted,#6B6456)] mb-1">いまの推定時給</p>
            <p
              aria-live="polite"
              aria-atomic="true"
      ...
      <section className="mb-4">
        <p className="text-xs font-bold text-[var(--n-muted,#6B6456)] uppercase tracking-widest mb-3">
          稼働中のノート
        </p>
