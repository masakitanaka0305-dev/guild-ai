      ...
      <div className="section-card p-4">
        <label className="flex items-start gap-3 cursor-pointer">
          <input
            ...
            className="mt-0.5 w-4 h-4 accent-[var(--n-primary,#0000CC)] flex-shrink-0"
            aria-label="利用規約と権利譲渡条件に同意します"
          />
          <span className="text-xs text-[var(--n-muted,#6B6456)] leading-relaxed">
            <a href="/legal/terms" target="_blank" className="text-[var(--n-primary,#0000CC)] hover:underline font-semibold">利用規約</a>
            {" "}と{" "}
            <a href="/legal/transfer" target="_blank" className="text-[var(--n-primary,#0000CC)] hover:underline font-semibold">権利譲渡条件</a>
            {" "}に同意します。
          </span>
        </label>
      </div>
