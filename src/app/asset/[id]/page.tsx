  ...
  const emotionalContent = (
    <>
      ...
      <Link
        ...
        className="mt-3 inline-flex items-center gap-1 text-xs text-[var(--primary,#06B6D4)] hover:underline font-semibold"
      >
        この知能の家系図を見る →
      </Link>
      ...
      <Link
        ...
        className="mt-1 inline-flex items-center gap-1 text-xs text-[var(--n-muted,#6B6456)] hover:text-[var(--primary,#06B6D4)] hover:underline font-semibold transition-colors"
      >
        このノートを使ったパイプラインを見る →
      </Link>
    ...
    <main className="px-4 sm:px-6 lg:px-8 py-8 max-w-3xl mx-auto">
      ...
      {(() => {
        const intensityColor: Record<string, string> = {
          high:   "bg-[var(--primary,#06B6D4)] text-white",
          ...
          <div className="mt-4 section-card p-4">
            ...
            <div className="space-y-1.5 text-sm">
              ...
              <div className="flex justify-between pt-1.5 border-t border-white/10">
                <span className="text-text-primary">1リクエスト</span>
      ...
      <div className="mt-6 section-card p-5">
        ...
        <ul className="space-y-2">
          {[
            ...
            <li key={lockItem} className="flex items-start gap-2 text-sm text-text-primary">
