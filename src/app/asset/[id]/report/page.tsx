          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div key={label} className="section-card p-4 text-center print:border print:border-gray-200">
                <p className={`text-lg font-black ${highlight ? "text-[var(--n-primary,#0000CC)]" : "text-[var(--n-text,#1A1714)]"}`}>
                  {value}
                </p>
                ...
                return (
                  <div key={i} className="flex-1 flex flex-col items-center gap-0.5">
                    <div
                      ...
                      className="w-full rounded-t bg-[var(--n-primary,#0000CC)] opacity-70"
                    />
                  </div>
                );
              })}
