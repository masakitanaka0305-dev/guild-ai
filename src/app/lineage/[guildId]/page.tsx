...
const RANK_COLOR: Record<string, string> = { S: "#D4AF37", A: "#4C1D95", B: "#9890A8" };
  ...
  return (
    <main className="px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto py-8">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs font-semibold transition-colors ${
                layoutMode === mode
                  ...
                  : "bg-white border border-gray-200 text-[var(--n-muted,#6B6456)] hover:border-[var(--primary,#4C1D95)]"
              }`}
            >
      ...
      <div className="flex flex-wrap gap-4 mb-4 text-xs text-[var(--n-muted,#6B6456)]">
        {[
          { label: "自分のノート", color: "border-[#4C1D95]", bg: "bg-[#FAFAF7]" },
