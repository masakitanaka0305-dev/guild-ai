  ...
  return (
    <main className="min-h-screen bg-[#0A0F1E] text-white" lang="en">
      ...
      <section className="relative overflow-hidden px-6 py-20 text-center sm:px-12 lg:px-24">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/sell"
              className="inline-flex items-center justify-center rounded-2xl bg-[#4C1D95] px-8 py-4 text-base font-bold text-white hover:bg-red-600 transition-colors active:scale-95"
            >
              Open My Account
            </Link>
            <Link
      ...
      <section className="px-6 py-20 sm:px-12 lg:px-24 text-center">
        ...
        <Link
          href="/sell"
          className="inline-flex items-center justify-center rounded-2xl bg-[#4C1D95] px-10 py-5 text-lg font-bold text-white hover:bg-red-600 transition-colors active:scale-95"
        >
          Open My Account →
        </Link>
      </section>
