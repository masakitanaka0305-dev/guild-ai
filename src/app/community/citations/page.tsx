        ...
        <div className="flex gap-2 mt-4">
          {!done && (
            <button
              ...
              className="flex-1 h-10 rounded-full bg-[var(--primary,#06B6D4)] text-white text-sm font-bold hover:opacity-90 transition-all"
            >
              尊敬する
            </button>
          )}
          ...
          <div className="bg-[var(--n-surface,#FFFFFF)] border border-[var(--n-divider,rgba(0,0,0,0.08))] rounded-2xl overflow-hidden shadow-sm">
            ...
            >
              ...
              {positions.map((pos) => {
                ...
                const rankColor = pos.node.rank === "S" ? "#D4AF37" : pos.node.rank === "A" ? "#06B6D4" : "#9890A8";
                return (
                  <g
                    key={pos.id}
            ...
            <div className="px-4 pb-3 flex items-center gap-4">
              <div className="flex items-center gap-1.5">
                <div className="w-6 h-0.5 bg-[#06B6D4] rounded-full" />
              ...
              {masters.map((m, i) => (
                <li key={m.handle} className="flex items-center gap-2.5">
                  ...
                  <button
                    ...
                    className="shrink-0 text-[9px] font-semibold text-[var(--primary,#06B6D4)] border border-[var(--primary,#06B6D4)]/30 rounded-full px-2 py-0.5 hover:bg-[var(--primary,#06B6D4)]/5 transition-colors"
