        ...
        <div className="flex gap-2 mt-4">
          {!done && (
            <button
              ...
              className="flex-1 h-10 rounded-full bg-[var(--primary,#4C1D95)] text-white text-sm font-bold hover:opacity-90 transition-all"
            >
              尊敬する
            </button>
          )}
          ...
          <div className="bg-[var(--n-surface,#FFFFFF)] border border-[var(--n-divider,rgba(0,0,0,0.08))] rounded-2xl overflow-hidden shadow-sm">
            ...
            >
              ...
              {positions.map((pos) => {
                ...
                const rankColor = pos.node.rank === "S" ? "#D4AF37" : pos.node.rank === "A" ? "#4C1D95" : "#9890A8";
                return (
                  <g
                    key={pos.id}
            ...
            <div className="px-4 pb-3 flex items-center gap-4">
              <div className="flex items-center gap-1.5">
                <div className="w-6 h-0.5 bg-[#4C1D95] rounded-full" />
              ...
              {masters.map((m, i) => (
                <li key={m.handle} className="flex items-center gap-2.5">
                  ...
                  <button
                    ...
                    className="shrink-0 text-[9px] font-semibold text-[var(--primary,#4C1D95)] border border-[var(--primary,#4C1D95)]/30 rounded-full px-2 py-0.5 hover:bg-[var(--primary,#4C1D95)]/5 transition-colors"
