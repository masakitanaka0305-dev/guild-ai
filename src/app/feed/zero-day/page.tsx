...
const PRIORITY_COLOR: Record<string, string> = {
  critical: "bg-[var(--primary,#4C1D95)] text-white",
          ...
          {isCovered && event.coveredBy && (
            <div className="rounded-xl border border-green-100 bg-green-50/60 p-3 mb-3">
              ...
              <Link
                ...
                className="text-xs font-semibold text-[var(--primary,#4C1D95)] hover:underline"
              >
          ...
          <div className="flex items-center gap-2">
            {!isCovered && (
              <Link
                ...
                className="rounded-lg bg-[var(--primary,#4C1D95)] px-3 py-1.5 text-xs font-bold text-white hover:opacity-90 transition-opacity"
              >
                対応MDを出品する →
              </Link>
            )}
    ...
    <main className="px-4 sm:px-6 lg:px-8 py-8 max-w-3xl mx-auto">
      ...
      <div className="mt-4 mb-6">
        <div className="flex items-center gap-2 mb-1">
          ...
          {recruitingCount > 0 && (
            <span className="rounded-full bg-[var(--primary,#4C1D95)] px-2.5 py-0.5 text-xs font-bold text-white">
      ...
      <div className="mb-5 grid grid-cols-3 gap-2">
        ...
        <div className="section-card p-3 text-center">
          ...
          <p className="text-lg font-extrabold tabular-nums text-[var(--primary,#4C1D95)]">
            {recruitingCount}
          </p>
        </div>
      </div>
