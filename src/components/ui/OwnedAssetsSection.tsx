...
const STATUS_PILL: Record<string, string> = {
  ...
  "Deployed":        "bg-brand-primary/15 text-brand-primary ring-brand-primary/30",
};

const STATUS_DOT: Record<string, string> = {
  "Private (Vault)": "bg-slate-400",
  "Encrypted":       "bg-emerald-400",
  "Deployed":        "bg-brand-primary",
};

// Friendly-tone display for the internal status enum (#127 — お仕事中).
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="rounded-xl border border-white/5 bg-midnight-base p-4 mb-4"
      >
