  ...
  return (
    ...
    >
      <g transform="translate(0,0) rotate(0 50 50)">
        <polygon points={HEX} fill="#22D3EE" fillOpacity={0.30} stroke="#22D3EE" strokeOpacity={0.80} strokeWidth={1.5} />
      </g>
      ...
      <g transform="translate(-6,6) rotate(0 50 50)">
        <polygon points={HEX} fill="#FDE047" fillOpacity={0.25} stroke="#FDE047" strokeOpacity={0.80} strokeWidth={1.5} />
      </g>
    </svg>
  );
}
