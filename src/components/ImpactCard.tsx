    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="bg-[var(--n-surface-2,#F5F3EE)] rounded-2xl px-4 py-4 text-center">
          <p className="text-3xl font-extrabold tabular-nums text-[var(--primary,#06B6D4)] leading-none mb-1">
            {savedProjects}
          </p>
      ...
      >
        ...
        <span className="text-xs font-bold text-[var(--n-text,#1A1714)]">
          今月 <span className="text-[var(--primary,#06B6D4)]">#{thisMonthRank}</span>
        </span>
