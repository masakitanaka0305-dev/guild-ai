      ...
      <div className="w-full max-w-sm bg-[var(--n-bg,#FAFAF7)] rounded-2xl shadow-2xl p-6">
        {submitted ? (
          <div className="text-center py-4">
            ...
            <button onClick={onClose} className="text-sm font-semibold text-[var(--n-primary,#E64545)] hover:underline">
              閉じる
            </button>
          </div>
        ) : (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-[var(--n-divider,rgba(0,0,0,0.12))] bg-[var(--n-surface-2,#F5F3EE)] px-3 py-2 text-sm text-[var(--n-text,#1A1714)] focus:outline-none focus:ring-2 focus:ring-[var(--n-primary,#E64545)]"
                >
                  {REASONS.map((r) => (
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full rounded-lg border border-[var(--n-divider,rgba(0,0,0,0.12))] bg-[var(--n-surface-2,#F5F3EE)] px-3 py-2 text-sm text-[var(--n-text,#1A1714)] placeholder:text-[var(--n-muted,#6B6456)] focus:outline-none focus:ring-2 focus:ring-[var(--n-primary,#E64545)] resize-none"
                />
              </div>
              <div className="flex gap-3">
                ...
                <button
                  type="submit"
                  className="flex-1 rounded-lg bg-[var(--n-primary,#E64545)] py-2 text-sm font-bold text-white hover:opacity-90 transition-opacity"
                >
                  送信する
                </button>
              </div>
