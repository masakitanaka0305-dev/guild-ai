        ...
        <>
          <div className="flex gap-2 mb-3">
            ...
            <button
              ...
              disabled={scanning}
              aria-busy={scanning}
              className="flex-shrink-0 rounded-xl bg-[#4C1D95] px-4 py-2 text-sm font-bold text-white hover:bg-red-600 active:scale-95 transition disabled:opacity-60"
            >
              {scanning ? "…" : "スキャン開始"}
            </button>
          </div>
          ...
          {assets.length > 0 && (
            <>
              ...
              <button
                ...
                className="w-full rounded-xl bg-[#4C1D95] py-3 text-sm font-bold text-white hover:bg-red-600 active:scale-95 transition disabled:opacity-40"
              >
