        ...
        >
              ...
              <div key={i} className={`flex ${m.role === "user" ? "justify-end" : "justify-start"}`}>
                <div
                  className={`max-w-[80%] rounded-xl px-3 py-2 text-xs leading-relaxed ${
                    m.role === "user"
                      ? "bg-[var(--n-primary,#E64545)] text-white rounded-br-sm"
          ...
          <div className="flex gap-2 px-3 py-2 border-t border-kuroko/10">
            ...
            <button
              ...
              disabled={!input.trim()}
              aria-label="送信"
              className="w-8 h-8 rounded-full bg-[var(--n-primary,#E64545)] text-white flex items-center justify-center disabled:opacity-40 active:scale-95 transition-all flex-shrink-0"
            >
