  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {effectiveUnread > 0 && (
          <>
            <span aria-hidden className="absolute top-0.5 right-0.5 w-2 h-2 rounded-full bg-brand-primary" />
            <span className="absolute -top-0.5 -right-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-brand-primary text-[10px] font-bold text-text-on-primary">
              {effectiveUnread}
            </span>
          </>
        )}
