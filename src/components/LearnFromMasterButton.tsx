              ...
              {notes.map((note, i) => (
                <li key={note.guildId}>
                  <Link
                    ...
                    className="flex items-center gap-3 rounded-2xl border border-[var(--n-divider,rgba(0,0,0,0.08))] px-4 py-3 hover:border-[var(--n-primary,#0000CC)] hover:bg-red-50 transition-colors"
                  >
